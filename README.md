...
## Skills
* **Cloud:** AWS
* **Infrastructure:** Kubernetes, Windows Hypervisor Platform(Hyper-V), CDK(CloudFormation), Terraform
* **Server/Network:** Windows Server, Linux, LXC, Container, In/exterior Networking[^Networking]
* **Language:** Kotlin, TypeScript, Python 3
* **Framework:** Spring Boot, Ktor, Compose Multiplatform, Astro, Svelte, Next.js, tRPC
...
* Blog: [blog.donghoon.net](https://blog.donghoon.net)
* Email: yoo\[at\]donghoon.net
* Matrix: @donghoon:matrix.org

---

<b>© 2025 DongHoon Yoo. All rights reserved.</b>  
